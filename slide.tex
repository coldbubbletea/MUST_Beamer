...
\author{哈哈哈}
\title{MUST Beamer Theme}
\subtitle{校赛题解}
\institute{MUST 程式設計校隊}
\date{2020年1月2日}
\usepackage{MacauUST}
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.2\linewidth]{pic/MUST_ICPC.pdf}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}{用Beamer很高大上？}
    \begin{itemize}[<+-| alert@+>] % 当然，除了alert，手动在里面插 \pause 也行
        ...
        \item 没有Overleaf项目
        \item 没有GitHub项目，如果有bug或者feature request请自己动手
    \end{itemize}
\end{frame}
...
\begin{frame}
    改编自\url{https://github.com/tuna/THU-Beamer-Theme}
    \begin{itemize}
        \item 有一些 \LaTeX{} 自带的
        \item 有一些Tsinghua的
